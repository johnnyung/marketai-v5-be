...
export const polygonCryptoModule = {
    name: "polygon-crypto", category: "alt",
    async run(ctx) {
        const result = { module: "polygon-crypto", status: "success", itemsFetched: 0, itemsWritten: 0, errors: [] };
        ...
        for (const coin of coins) {
            try {
                ...
                result.errors.push(`Crypto ${coin}: ${e.message}`);
            }
        }
        return result;
    }
